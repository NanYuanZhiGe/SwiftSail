...
@Dao
public abstract class RecordHeartRateTable extends RecordTableBase{
    ...
    @Query("SELECT `exposeValue` FROM `recordHeartRateTable` " +
    ...
    @Query("SELECT AVG(exposeValue) FROM `recordHeartRateTable` " +
    ...
    @Query("SELECT `epochDay` FROM `recordHeartRateTable` " +
    ...
    @Query("SELECT `epochYear` FROM `recordHeartRateTable` " +
            "WHERE `userId`=:userId " +
