...
@Dao
public abstract class RecordDistanceTable extends RecordTableBase {
    ...
    @Query("SELECT `exposeValue` FROM `recordDistanceTable` " +
    ...
    @Query("SELECT AVG(exposeValue) FROM `recordDistanceTable` " +
    ...
    @Query("SELECT `epochDay` FROM `recordDistanceTable` " +
    ...
    @Query("SELECT `epochYear` FROM `recordDistanceTable` " +
            "WHERE `userId`=:userId " +
