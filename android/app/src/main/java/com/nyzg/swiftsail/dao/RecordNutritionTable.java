...
@Dao
public abstract class RecordNutritionTable extends RecordTableBase{
    ...
    @Query("SELECT `exposeValue` FROM `recordNutritionTable` " +
    ...
    @Query("SELECT AVG(exposeValue) FROM `recordNutritionTable` " +
    ...
    @Query("SELECT `epochDay` FROM `recordNutritionTable` " +
    ...
    @Query("SELECT `epochYear` FROM `recordNutritionTable` " +
            "WHERE `userId`=:userId " +
