...
public class GlobalToast {
    ...
    public static final Consumer<String> RESPONSE_NOT_SUCCESS = msg -> handler.post(() -> Toast.makeText(GlobalApplication.getAppContext(), String.format("响应成功，请求失败：%s", msg), Toast.LENGTH_LONG).show());
