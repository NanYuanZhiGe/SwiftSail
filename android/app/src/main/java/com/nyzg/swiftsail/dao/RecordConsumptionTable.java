...
@Dao
public abstract class RecordConsumptionTable extends RecordTableBase{
    ...
    @Query("SELECT `exposeValue` FROM `recordConsumptionTable` " +
    ...
    @Query("SELECT AVG(exposeValue) FROM `recordConsumptionTable` " +
    ...
    @Query("SELECT `epochDay` FROM `recordConsumptionTable` " +
    ...
    @Query("SELECT `epochYear` FROM `recordConsumptionTable` " +
            "WHERE `userId`=:userId " +
