...
@Dao
public abstract class RecordSleepTable extends RecordTableBase {
    ...
    @Query("SELECT `exposeValue` FROM `recordSleepTable` " +
    ...
    @Query("SELECT AVG(exposeValue) FROM `recordSleepTable` " +
    ...
    @Query("SELECT `epochDay` FROM `recordSleepTable` " +
    ...
    @Query("SELECT `epochYear` FROM `recordSleepTable` " +
            "WHERE `userId`=:userId " +
